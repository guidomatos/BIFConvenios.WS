...
Public Class CobranzaBL
    Private ReadOnly lRutaImportacionArchivos As String ' = ConfigurationManager.AppSettings("RutaImportacionArchivos").Trim()
    Private ReadOnly lLog As Log

    Public Sub New()
        MyBase.New()
        lRutaImportacionArchivos = ConfigurationManager.AppSettings("RutaImportacionArchivos").Trim()
        lLog = New Log()
    End Sub
    ...
    Public Function AnulaEnvioCobranzaIBS(pCodigo_proceso As String, pUsuario As String) As Integer
        ...
        Try
            lLog.GrabarLog(1, "AnulaEnvioCobranzaIBS", ("Inicio del Metodo - Parametros:  pCodigo_proceso=" & pCodigo_proceso & ", pUsuario=" & pUsuario), "", pUsuario)
            Dim table As DataTable = odo.ObtieneProcesoCliente(pCodigo_proceso)
            ...
            End If
            Dim str2 As String = edo.ObtenerCodigoClienteIBS(pTipoDocumento, pNumeroDocumento)
            ...
            Finally
                ...
                End If
            End Try
            lLog.GrabarLog(1, "AnulaEnvioCobranzaIBS", ("Fin del Metodo - Parametros:  pCodigo_proceso=" & pCodigo_proceso & ", pUsuario=" & pUsuario), "", pUsuario)
        Catch exception1 As Exception
            Dim ex As Exception = exception1
            ProjectData.SetProjectError(ex)
            Dim exception As Exception = ex
            lLog.GrabarLog(3, "AnulaEnvioCobranzaIBS", exception.Message, exception.StackTrace, pUsuario)
            num2 = 1
    ...
    Public Function EnvioCobranzaIBS(pCodigo_proceso As String, pUsuario As String) As Integer
        Dim ado As New CobranzaDO
        Dim odo As New ProcesoDO
        Dim num3 As Integer = 0
        Try
            lLog.GrabarLog(1, "EnvioCobranzaIBSProcesa", ("Inicio del Metodo - Parametros:  pCodigo_proceso=" & pCodigo_proceso), "", pUsuario)
            Dim flag2 As Boolean = (odo.ObtieneProcesoCliente(pCodigo_proceso).Rows.Count > 0)
            If Not flag2 Then
                lLog.GrabarLog(1, "EnvioCobranzaIBSProcesa", ("Parametros:  pCodigo_proceso=" & pCodigo_proceso), "El proceso no tiene datos de cobranzas.", pUsuario)
                GoTo TR_0002
            Else
                Dim enumerator As IEnumerator = Nothing
                odo.InicioEnvioCobranza(pCodigo_proceso, pUsuario)
                Dim table As DataTable = ado.ObtieneCobranzas(pCodigo_proceso)
                Try
                    ...
                    Do While True
                        ...
                        Catch exception1 As Exception
                            ...
                            ProjectData.SetProjectError(ex)
                            Dim exception As Exception = ex
                            lLog.GrabarLog(3, "EnvioCobranzaIBSProcesa - Eliminamos Cobranza en IBS", exception.Message, exception.StackTrace, pUsuario)
            ...
            GoTo TR_0003
TR_0002:
            lLog.GrabarLog(1, "EnvioCobranzaIBSProcesa", ("Fin del Metodo - Parametros:  pCodigo_proceso=" & pCodigo_proceso), "", pUsuario)
...
TR_0003:
        ...
        Catch exception3 As Exception
            ...
            lLog.GrabarLog(3, "EnvioCobranzaIBSProcesa", exception2.Message, exception2.StackTrace, pUsuario)
            num3 = 1
            ProjectData.ClearProjectError()
        End Try
        Return num3
    ...
    Public Function ImportaDescuentosEmpresa(pNombreArchivo As String, pUsuario As String) As Integer
        Dim num As Integer
        Dim odo As New ProcesoDO
        Dim ado As New CobranzaDO
        Try
            lLog.GrabarLog(1, "ImportaDescuentoEmpresa", ("Inicio del Metodo - Parametros: pNombreArchivo=" & pNombreArchivo & ",pUsuario=" & pUsuario), "", pUsuario)
    ...
    Public Function ImportaDescuentosEmpresa(pCodigo_proceso As String, pNombreArchivo As String, pUsuario As String) As String
        Dim odo As New ProcesoDO
        Dim ado As New CobranzaDO
        Dim str2 As String = String.Empty
        Try
            ...
            lLog.GrabarLog(1, "ImportaDescuentoEmpresa", String.Concat(strArray), "", pUsuario)
            Dim table2 As DataTable = clsFiles.ConvertToDateTable(pNombreArchivo, str2)
            Dim flag As Boolean = ((table2.Rows.Count > 0) And (str2 = ""))
            If Not flag Then
                lLog.GrabarLog(3, "ImportaDescuentoEmpresa", str2, str2, pUsuario)
            Else
                ...
                Try
                    ...
                    Dim table As DataTable = New ArchivoXLS().FiltraSoloRegistrosXLS(table2)
                    Try
                        enumerator = table.Rows.GetEnumerator
                        Do While True
                ...
                Finally
                    ...
                    End If
                End Try
                lLog.GrabarLog(1, "ImportaDescuentoEmpresa", String.Concat(New String() {"Fin del Metodo - Parametros:  pCodigo_proceso=", pCodigo_proceso, ",pNombreArchivo=", pNombreArchivo, ",pUsuario=", pUsuario}), "", pUsuario)
            End If
        Catch exception1 As Exception
            Dim ex As Exception = exception1
            ProjectData.SetProjectError(ex)
            Dim exception As Exception = ex
            lLog.GrabarLog(3, "ImportaDescuentoEmpresa", exception.ToString, exception.StackTrace, pUsuario)
    ...
    Public Function ImportaDescuentosEmpresa(pCodigo_proceso As String, pNombreArchivo As String, pTipoFormatoArchivo As String, pUsuario As String) As Integer
        ...
        Dim pFechaFormateada As String = Format(Now, "yyyyMMddhhmmss")
        Dim obj2 As Object = (lRutaImportacionArchivos & pNombreArchivo)
        ...
        Try
            ...
            lLog.GrabarLog(1, "ImportaDescuentoEmpresa", String.Concat(strArray), "", pUsuario)
            Dim flag As Boolean = (UCase(pTipoFormatoArchivo) = "XLS")
            If flag Then
                table = New ArchivoXLS().ImportaXLS((lRutaImportacionArchivos & pNombreArchivo))
            End If
            Dim objA As New TransactionScope(TransactionScopeOption.RequiresNew)
            Try
                ...
                odo.InicioDescuentoEmpresa(pCodigo_proceso, pUsuario)
                Dim str4 As String = UCase(pTipoFormatoArchivo)
                flag = (str4 = "XLS")
                If flag Then
                    Dim enumerator As IEnumerator = Nothing
                ...
                Else
                    ...
                    If flag Then
                        Dim enumerator As IEnumerator = Nothing
                        table2 = New ArchivoCSV().ImportaCSV((lRutaImportacionArchivos & pNombreArchivo))
                        Try
                            enumerator = table2.Rows.GetEnumerator
                            Do While True
                                flag = enumerator.MoveNext
                    ...
                    Else
                        ...
                        If flag Then
                            Dim enumerator As IEnumerator = Nothing
                            'table2 = New ArchivoTXT().ImportaTXTEncolumnado((lRutaImportacionArchivos & pNombreArchivo))
                            table2 = New ArchivoTXT().ImportaTXTGenerico((lRutaImportacionArchivos & pNombreArchivo))
                            Try
                                enumerator = table2.Rows.GetEnumerator
                                Do While True
                                    flag = enumerator.MoveNext
                        ...
                        Else
                            ...
                            If flag Then
                                Dim enumerator As IEnumerator = Nothing
                                table2 = New ArchivoDBF().LeerDBF((lRutaImportacionArchivos & pNombreArchivo))
                                pNroLinea = 0
                                Try
                                    enumerator = table2.Rows.GetEnumerator
                                    Do While True
                                        ...
                                        End If
                                        current = DirectCast(enumerator.Current, DataRow)
                                        strArray = New String() {LSet(Conversions.ToString(current("dni")), 15), RSet(Format(current("process"), "##########0.00"), 15), " ", Left(LSet((Trim(Conversions.ToString(current("apellidos"))) & " " & Trim(Conversions.ToString(current("nombres")))), 50), 50), " ", RSet(Format(current("monto"), "##########0.00"), 15)}
                                ...
                                If flag Then
                                    ...
                                    Try
                                        ...
                                        Do While True
                                            ...
                                            End If
                                            current = DirectCast(enumerator.Current, DataRow)
                                            strArray = New String() {LSet(Right(("0000000000" & Trim(Conversions.ToString(current("CODIGO")))), 10), 15), RSet(Format(current("MONVAR"), "##########0.00"), 15), " ", Left(LSet(Trim(Conversions.ToString(current("NOMPER"))), 50), 50), " ", LSet(Conversions.ToString(current("CLASE")), 15)}
                                            pData = String.Concat(strArray)
                                            ado.TemporalArchivoTextoInserta(pCodigo_proceso, pUsuario, pNroLinea, pData, pFechaFormateada)
                                            pNroLinea += 1
                                        Loop
            ...
            Finally
                ...
                End If
            End Try
            lLog.GrabarLog(1, "ImportaDescuentosClientes", String.Concat(New String() {"Fin del Metodo - Parametros:  pCodigo_proceso=", pCodigo_proceso, ",pNombreArchivo=", pNombreArchivo, ",pTipoFormatoArchivo=", pTipoFormatoArchivo, ",pUsuario=", pUsuario}), "", pUsuario)
        Catch exception1 As Exception
            Dim ex As Exception = exception1
            ProjectData.SetProjectError(ex)
            Dim exception As Exception = ex
            lLog.GrabarLog(3, "ImportaDescuentosClientes", exception.Message, exception.StackTrace, pUsuario)
            num3 = 1
            ProjectData.ClearProjectError()
        End Try
        Return num3
    ...
    Public Function ImportaDescuentosEmpresaAutomatico(pNombreArchivo As String, pUsuario As String, ByRef pCodigoProceso As String, ByRef pEstado As Integer, ByRef pCodigoCliente As Integer, ByRef pCodigoIBS As Integer, ByRef pAnioPeriodo As Integer, ByRef pMesPeriodo As Integer) As String
        ...
        Try
            ...
            Dim table3 As DataTable = clsFiles.ConvertToDateTable(pNombreArchivo, procesandoArchivoDescuento)
            ...
            Else
                Try
                    ...
                    Dim table As DataTable = edo.ObtenerClientePorCodigo(pintCodigoCliente)
                    Dim str6 As String = table.Rows(0)("Nombre_Cliente").ToString.Trim
                    Dim num2 As Integer = Conversions.ToInteger(table.Rows(0)("codigo_IBS"))
                    pCodigoIBS = num2
                    Dim table5 As DataTable = odo.ObtenerListaProcesosEsperaArchivoDescuentoByCliente(str2, str5, pintCodigoCliente)
                    pCodigoProceso = table5.Rows(0)("Codigo_proceso").ToString
                    Dim str3 As String = table5.Rows(0)("Estado").ToString
                    If Not (((str3 <> "A2") And (str3 <> "A3")) And (str3 <> "EA")) Then
                        ...
                        pEstado = 3
                    Else
                        Dim num10 As Integer = -odo.ConsultaFlagCargaAutomatica
                        ...
                        Else
                            ...
                            Try
                                ...
                                Dim table2 As DataTable = New ArchivoXLS().FiltraSoloRegistrosXLS(table3)
                                Try
                                    enumerator = table2.Rows.GetEnumerator
                                    Do While True
                                    ...
                                    Loop
                                Finally
                                    flag4 = TryCast(enumerator, IDisposable) IsNot Nothing
                                    If flag4 Then
                                        TryCast(enumerator, IDisposable).Dispose()
                                    End If
                                End Try
                            ...
                            Else
                                ...
                                Try
                                    ...
                                    Dim num3 As Integer = Convert.ToInt32(resumenProcesoDescuentos.Rows(0)("ErroresArchivo").ToString)
                                    Dim num4 As Integer = Convert.ToInt32(resumenProcesoDescuentos.Rows(0)("ErroresArchivoDescuento").ToString)
                                    Dim num9 As Integer = Convert.ToInt32(resumenProcesoDescuentos.Rows(0)("Validos").ToString)
                                    Dim num8 As Integer = Convert.ToInt32(resumenProcesoDescuentos.Rows(0)("TotalArchivo").ToString)
                                    Dim num5 As Integer = Convert.ToInt32(resumenProcesoDescuentos.Rows(0)("ErroresTablaEnvio").ToString)
                                    Dim num7 As Integer = Convert.ToInt32(resumenProcesoDescuentos.Rows(0)("Total").ToString)
                                    ...
                                    End If
                                    strArray = New String() {path, "\\", str6, "-", num2.ToString, "(", Now.Year.ToString, Now.Month.ToString, Now.Day.ToString}
                                    strArray(9) = "-"
                                    strArray(10) = Now.Hour.ToString
                                    strArray(11) = Now.Minute.ToString
                                    strArray(12) = Now.Second.ToString
                                    strArray(13) = ").xls"

...
namespace DAL
{
    public class DASQL
    {
        ...
        public string DescrifarCadenaConexion(string pstrCadenaCifrada)
        {
            ...
            string strCadenaDescifrada = pstrCadenaCifrada;
            if (ConfigurationManager.AppSettings["cifrado"].ToString() == "1")
            {
                ...
                try
                {
                    string strCadenaConexionAntesPasswordCifrado = pstrCadenaCifrada.Substring(0, pstrCadenaCifrada.IndexOf("Password") + 9);
                    string strTemporal = pstrCadenaCifrada.Substring(pstrCadenaCifrada.IndexOf("Password") + 9);
                    string strCadenaConexionDespuesPasswordCifrado = strTemporal.Substring(strTemporal.IndexOf(";"));
                    string strPasswordCifrado = strTemporal.Substring(0, strTemporal.IndexOf(";"));
                    string strPasswordDescifrado = c.Decodifica(strPasswordCifrado);
                    strCadenaDescifrada = strCadenaConexionAntesPasswordCifrado + strPasswordDescifrado + strCadenaConexionDespuesPasswordCifrado;
        ...
        public void CommandProperties(ref SqlCommand Command, string strCommandName)
        {
            if (con == null)
            {
                ConnectionOpen();

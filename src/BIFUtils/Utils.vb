...
Namespace WS
    Public Class Utils
        ...
        Public Shared Sub RemoveFiles(strPath As String, tmsp As TimeSpan)
            ...
            For Each fri In fiArr
                If fri.Extension.ToString() = ".xls" Or fri.Extension.ToString() = ".csv" Then
                    If (fri.CreationTime < Date.Now.Subtract(tmsp)) Then
                        fri.Delete()
                    End If
                End If
            Next
        ...
        Public Shared Function CadenaConexion(strClaveConfiguracion As String) As String
        ...
        Public Function DescifrarCadenaConexion(cadena_cifrada) As String
        ...
        Public Shared Sub SendNotification(strFrom As String, strTo As String,

    ...
    public class Email
    {
                                    ...
                                    )
        {
            try
            {
                ...
                {
                    From = new MailAddress(pstrEmailFrom)
                };
                ...
                {
                    Host = pstrSMTPServer,
                    UseDefaultCredentials = pbUseDefaultCredentials,
                    EnableSsl = pbEnabledSSL,
                    Port = pintSMTPPort,
                    Credentials = new System.Net.NetworkCredential(pstrSMTPUserName, pstrSMTPPassword)
                };
                smtp.Send(mail);
                mail.Dispose();

...
<ServiceContract()>
Public Interface IWsReportesAutomatico
    <OperationContract()>
    ...
    <OperationContract()>
    Function GetFuncionarios() As DataTable
    <OperationContract()>
    Function EnviarReporteAutomaticoByFuncionario(pintCodigoProcesoAutomatico As Integer, pintFuncionarioId As Integer, pstrNombreFuncionario As String, pstrCEFuncionario As String, pstrUsuario As String, ByRef pintEstado As Integer) As String
    <OperationContract()>
    Sub ReportesAutomaticos()
End Interface
